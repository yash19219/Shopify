...
CREATE TABLE `order` (
  ...
  PRIMARY KEY (`oid`,`Customer_cid`),
  KEY `fk_Order_Customer1_idx` (`Customer_cid`),
  KEY `OrderIdIndexTable` (`oid`),
...
INSERT INTO `order` VALUES (1,10,1),(2,20,2),(3,30,3),(4,200000,4),(5,50,5),(6,20,6),(7,30000,7),(8,200000,8),(9,10000,9),(10,600,10),(11,150,11),(12,40000,12),(13,50,13),(14,40,14),(15,750,15);
