...
CREATE TABLE `cart_has_product` (
  ...
  KEY `fk_Cart_has_Product_Product1_idx` (`Product_pid`),
  ...
  CONSTRAINT `fk_Cart_has_Product_Product1` FOREIGN KEY (`Product_pid`) REFERENCES `product` (`pid`)
...
INSERT INTO `cart_has_product` VALUES (1,2,1),(2,3,2),(3,1,3),(4,6,4),(5,5,1),(6,4,2),(7,9,3),(8,8,4),(9,7,1),(10,12,2),(11,11,3),(12,10,4),(13,15,1),(14,14,2),(15,13,3);
